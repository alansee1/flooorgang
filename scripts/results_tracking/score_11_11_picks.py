#!/usr/bin/env python3
"""
Score picks from 11/11 by fetching actual game results
...
def get_player_stats_for_date(player_name, date_str='Nov 11, 2025'):
...
def get_team_stats_for_date(team_name, date_str='2025-11-11'):
...
def main():
    ...
    result = supabase.table('picks').select('*').eq('scan_date', '2025-11-11').execute()
    picks = result.data
